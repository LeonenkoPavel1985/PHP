...
$date = date_create('2023-12-31');

echo 'К дате 2023-12-31 прибавляем 2 дня: ' . date_format(date_modify($date, '+ 2 day'), 'Y-m-d') . '.' . '<br>';
echo 'К дате 2024-01-02 прибавляем 1 месяц и 3 дня: ' . date_format(date_modify($date, '+ 1 month 3 day'), 'Y-m-d') . '.' . '<br>';
echo 'К дате 2024-02-05 прибавляем 1 год: ' . date_format(date_modify($date, '+ 1 year'), 'Y-m-d') . '.' . '<br>';
echo 'К дате 2025-02-05 отнимаем 3 дня: ' . date_format(date_modify($date, '- 2 day'), 'Y-m-d') . '.';

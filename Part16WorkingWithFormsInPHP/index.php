...
<!--6. Отправьте GET-запрос на показ определенной страницы сайта. Запишите адрес страницы в переменную $page. С помощью функции include() сделайте так, чтобы к странице index.php 
    подключалась страница из переменной $page. Создайте 5 файлов с различными названиями и с их помощью проверьте работу скрипта ('domain.ru/index.php?page=test.php).-->

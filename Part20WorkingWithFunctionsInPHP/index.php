...
// Такая задача часто возникает при обработке данных из БД. В БД мы можем хранить данные в виде нулей и единиц, либо коротких слов, а пользователю хотелось бы раскрыть смысл этих нулей и единиц.

...
// 25. Сделайте функцию, которая делает ссылку с определенным классом: первый класс она добавляет в случае, если адрес ссылки совпадает с текущей страницей, а второй класс - когда не совпадает. 
// Совет: адрес страницы лежит в $_SERVER['REQUEST_URI'].Функция должна вернуть примерно следующее: текст_ссылки. Такая задача нужна очень часто, практически на каждом сайте — для выделения 
// ссылки в меню, на которой мы находимся сейчас.
